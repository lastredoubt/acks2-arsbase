// Adapted from DF Template Enhancements
 ...
 */
export class LineToBoxCollision {

	 static _computeOutCode(x, y, bounds = { left, right, top, bottom })
	 {
		let code = OutCode;
	...
	static cohenSutherlandLineClipAndDraw(x0, y0, x1, y1, bounds= { left, right, top, bottom })
		{
		 // compute outcodes for P0, P1, and whatever point lies outside the clip rectangle
		let outcode0 = this._computeOutCode(x0, y0, bounds);
		let outcode1 = this._computeOutCode(x1, y1, bounds);
		let accept = false;
